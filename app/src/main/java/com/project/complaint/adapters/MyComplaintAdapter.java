...
public class MyComplaintAdapter extends RecyclerView.Adapter<MyComplaintAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppCompatTextView tvTitle, tvDesc, tvAddress, tvLandmark;
    ...
    public MyComplaintAdapter(Context mContext, List<Complaint> complaintList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_complaint, parent, false);
